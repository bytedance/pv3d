...
from lib.trainers.callbacks.checkpoint import CheckpointCallback
from lib.trainers.callbacks.early_stopping import EarlyStoppingCallback
from lib.trainers.callbacks.logistics import LogisticsCallback
from lib.trainers.callbacks.lr_scheduler import LRSchedulerCallback
from lib.trainers.core.callback_hook import TrainerCallbackHookMixin
from lib.trainers.core.device import TrainerDeviceMixin
from lib.trainers.core.evaluation_loop import TrainerEvaluationLoopMixin
from lib.trainers.core.training_loop import TrainerTrainingLoopMixin
from lib.trainers.core.profiling import TrainerProfilingMixin
from lib.common.build import build_model, build_dataset, build_optimizer
from lib.utils.general import print_model_parameters
from lib.common.metrics import Metrics
...
@registry.register_trainer("common")
class CommonTrainer(
    ...
    def load_datasets(self):
        ...
        self.dataset_loader = build_dataset(self.config)
    ...
    def generate_multiview(self):
        ...
        for dataset in dataset_type:
            self.on_prediction_start()
            self.generating_multiview_loop(dataset)
            self.on_prediction_end()
